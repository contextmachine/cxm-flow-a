...
export class ParamRange extends ValidationCore implements ParamRangeClassInterface {
  ...
  public getValues(): ParamRangeType {
  ...
  public get type(): "range" {
    return "range";
  }
}

// Define Zod schema for project metadata
const ParamRangeSchema = z.object(Validators);

// Infer TypeScript type from Zod schema
export type ParamRangeType = z.infer<typeof ParamRangeSchema>;

// Interface extending the inferred type with class-specific methods
interface ParamRangeClassInterface extends ParamRangeType {
  type: "range";
}
